...
public sealed class PromptBuilder
{
    ...
    /// <summary>Adds an input/output example. Dramatically improves output consistency.</summary>
    ...
    /// Throws InvalidOperationException if WithTask() was not called.
    /// </summary>
    public string Build()
    {
        if (_task is null)
